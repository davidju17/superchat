...
public class ChatServerMain {
	...
	public static synchronized void readFile(String username,ChatServerThread name) throws IOException {
		BufferedInputStream bufferedInput = new BufferedInputStream(new FileInputStream("database.data"));
		BufferedReader read = new BufferedReader(new InputStreamReader(bufferedInput, StandardCharsets.ISO_8859_1));
		String line = "";
		String identity = "";
		boolean flag = false;
		boolean flag2 = false;
